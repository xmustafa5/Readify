    ...
    <div className="backgroundCover flex gap-6 justify-center items-center w-full h-screen">
      ...
      ><AnimatePresence >
        ...
        <div className=" gap-6 flex flex-col">
          ...
          <p className="text-base w-full flex text-center justify-center">welcome back please login to your account</p>
          <div>
            <input 
              type="email"
              placeholder="EMAIL"
          ...
          <p className="w-full flex justify-center text-md">doesn't have ab a ccount, <Link className="text-[#936C1F]" href={'/signup'} >Sign Up</Link></p>
        </div>
              </motion.div>
